...
const reportIfAnonymousLogical = (
  context: Rule.RuleContext,
  test: { readonly type: string } | null | undefined,
) => {
...
const implementation: Rule.RuleModule = {
  meta: {
    ...
    messages: {
      namedPredicate:
        "Give this logical condition a name. Assign &&, ||, or ?? to a predicate variable or function. See rule named-predicates.",
    },
  },
  create(context) {
    return {
