...
export const collectionLoopsRule = defineRule({
    ...
    enforcement: {
        ...
        implementation: {
            ...
            create(context) {
                return {
                    "ForStatement, ForInStatement, WhileStatement, DoWhileStatement"(node) {
...
export const noLoopJumpsRule = defineRule({
    ...
    enforcement: {
        ...
        implementation: {
            ...
            create(context) {
                return {
                    "BreakStatement, ContinueStatement, LabeledStatement"(node) {
...
//# sourceMappingURL=loopControl.rules.js.map