...
export declare const defineRuleOptions: <Options extends readonly unknown[]>(schema: RuleOptions<Options>["schema"], validate?: (options: readonly unknown[]) => void) => RuleOptions<Options>;
export {};
